...
@section('content')
  ...
  <div class="site-register">
    <div class="register-body">
      ...
      <form action="{{ route('register') }}" method="POST" accept-charset="utf-8">
        ...
        <div class="input-group">
          ...
          <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Họ tên" value="{{ old('name') }}" required autocomplete="name" autofocus>
    ...
    <div class="register-social">
      <div class="register-social-text">Hoặc tiếp tục bằng</div>
      <div class="row">
        <div class="col-md-6">
    ...
    <div class="sign-in-now">
      Bạn là thành viên? <a href="{{ route('login') }}">Đăng nhập ngay</a>
    </div>
  </div>
@endsection
