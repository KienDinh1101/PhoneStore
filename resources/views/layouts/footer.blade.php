<footer class="footer">
        ...
        <div class="col-md-3 col-sm-4 col-xs-6 col-ssm">
          <div class="footer-widget">
            ...
            <div class="widget-content">
              <p><b><i class="fas fa-mobile-alt"></i> Hotline:</b><i>(+84) 123456789</i></p>
              <p><b><i class="fas fa-envelope"></i> Email:</b> <a href="#">phonestore2411@gmail.com</a></p>
  ...
  <div class="footer-bottom">
    <div class="copyright text-center">
      Copyright &copy 2020 By Cu Tuan Anh. All rights reserved.
    </div>
  </div>
</footer>
